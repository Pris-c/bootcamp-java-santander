...
public class Desafio16 {
    public static void main(String[] args) {
        ...
        Map<Boolean, List<Integer>> groups = numeros.stream().collect(Collectors.partitioningBy(n -> (n%2 ==0)));
        System.out.println(groups.get(false).stream().toList());
        System.out.println(groups.get(true).stream().toList());
